...
//#define STACK_USE_TELNET_CLIENT			// Telnet client
...
// 2012-05-07(Eric) - STACK_USE_REBOOT_SERVER removed since not used.
 ...
 */
#define MPFS_RESERVE_BLOCK				(137ul)  // (217ul)
 ...
 */
	...
	#define MY_DEFAULT_HOST_NAME			"ANACLE_METER"
	...
	#define MY_DEFAULT_HOST_NAME			"ANACLE_COMM"
 ...
 */
	...
	#define TCP_SOCKET_TYPES
		...
		#define TCP_PURPOSE_MODBUS 12
		#define TCP_PURPOSE_WEB_REQUEST 13
	#define END_OF_TCP_SOCKET_TYPES
		...
		} TCPSocketInitializer[] =
		{
			...
			{TCP_PURPOSE_WEB_REQUEST, TCP_ETH_RAM, 256, 256},
			...
			//{TCP_PURPOSE_MODBUS, TCP_ETH_RAM, 100, 100},
			{TCP_PURPOSE_MODBUS, TCP_ETH_RAM, 100, 100},
			//{TCP_PURPOSE_BERKELEY_SERVER, TCP_ETH_RAM, 25, 20},
			//{TCP_PURPOSE_BERKELEY_SERVER, TCP_ETH_RAM, 25, 20},
